export const mockWines = [
  ...
  },
  {
      ...
      "description": "For the first time, a blend of grapes from two different region's have been combined in an outrageous explosion of flavor that cannot be missed.",
      "price": 19.90, 
      "isOnSale": true, 
      "quantityInCart": 0, 
      "foodMatch": [
  ...
  },
  {
      ...
      "country": "USA",
      "region": "California",
      "description": "Keep an eye out for this winery in coming year's, as their chardonnays have reached the peak of perfection.",
      "price": 15.35, 
      "isOnSale": true, 
      "quantityInCart": 0, 
      "foodMatch": [
